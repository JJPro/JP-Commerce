...
this.button.removeClass("hidden");this.toggler.addClass("wp-picker-open");c("body").trigger("click.wpcolorpicker").on("click.wpcolorpicker",this.close)},close:function(){this.element.hide().iris("toggle");this.button.addClass("hidden");this.toggler.removeClass("wp-picker-open");c("body").off("click.wpcolorpicker",this.close)},color:function(a){if(a===d)return this.element.iris("option","color");this.element.iris("option","color",a)},defaultColor:function(a){if(a===d)return this.options.defaultColor;
this.options.defaultColor=a}})})(jQuery);
