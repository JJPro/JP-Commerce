jQuery(document).ready(function(a){var b,c,d,e=!1;b=function(){var b=a(".menu_order_input"),c=b.length;b.each(function(b){b=e?c-b:1+b;a(this).val(b)})};c=function(b){b=b||0;a(".menu_order_input").each(function(){if("0"===this.value||b)this.value=""})};a("#asc").click(function(a){a.preventDefault();e=!1;b()});a("#desc").click(function(a){a.preventDefault();e=!0;b()});a("#clear").click(function(a){a.preventDefault();c(1)});a("#showall").click(function(b){b.preventDefault();a("#sort-buttons span a").toggle();
a("a.describe-toggle-on").hide();a("a.describe-toggle-off, table.slidetoggle").show();a("img.pinkynail").toggle(!1)});a("#hideall").click(function(b){b.preventDefault();a("#sort-buttons span a").toggle();a("a.describe-toggle-on").show();a("a.describe-toggle-off, table.slidetoggle").hide();a("img.pinkynail").toggle(!0)});(function(){a("#media-items").sortable({items:"div.media-item",placeholder:"sorthelper",axis:"y",distance:2,handle:"div.filename",stop:function(){var b=a("#media-items").sortable("toArray"),
c=b.length;a.each(b,function(b,d){var f=e?c-b:1+b;a("#"+d+" .menu_order input").val(f)})}})})();c();1<a("#media-items>*").length&&(d=wpgallery.getWin(),a("#save-all, #gallery-settings").show(),"undefined"!==typeof d.tinyMCE&&d.tinyMCE.activeEditor&&!d.tinyMCE.activeEditor.isHidden()?(wpgallery.mcemode=!0,wpgallery.init()):a("#insert-gallery").show())});jQuery(window).unload(function(){tinymce=tinyMCE=wpgallery=null});var tinymce=null,tinyMCE,wpgallery;
