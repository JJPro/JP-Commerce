...
wp.Uploader.queue.off(null,null,this)},reset:function(){this.get("selection").reset();this.resetDisplays();this.refreshContent()},resetDisplays:function(){var b=wp.media.view.settings.defaultProps;this._displays=[];this._defaultDisplaySettings={align:d("align",b.align)||"none",size:d("imgsize",b.size)||"medium",link:d("urlbutton",b.link)||"none"}},display:function(b){var a=this._displays;a[b.cid]||(a[b.cid]=new Backbone.Model(this.defaultDisplaySettings(b)));return a[b.cid]},defaultDisplaySettings:function(b){var a=
...
this));this.$document.on("dragstart dragend drop",_.bind(function(a){this.localDrag="dragstart"===a.type;"drop"===a.type&&this.containerDragleave()},this));this.initialized=!0;return this},browserSupport:function(){var a=!1,a=document.createElement("div");return a=("draggable"in a||"ondragstart"in a&&"ondrop"in a)&&!!(window.File&&window.FileList&&window.FileReader)},isDraggingFile:function(a){return null!==this.draggingFile?this.draggingFile:_.isUndefined(a.originalEvent)||_.isUndefined(a.originalEvent.dataTransfer)?
!1:this.draggingFile=-1<_.indexOf(a.originalEvent.dataTransfer.types,"Files")&&-1===_.indexOf(a.originalEvent.dataTransfer.types,"text/plain")},refresh:function(a){for(var c in this.dropzones)this.dropzones[c].toggle(this.overContainer||this.overDropzone);_.isUndefined(a)||b(a.target).closest(".uploader-editor").toggleClass("droppable",this.overDropzone);this.overContainer||this.overDropzone||(this.draggingFile=null);return this},render:function(){if(!this.initialized)return this;d.prototype.render.apply(this,
arguments);b(".wp-editor-wrap").each(_.bind(this.attach,this));return this},attach:function(a,c){var d=this.$el.clone();this.dropzones.push(d);b(c).append(d);return this},drop:function(a){this.containerDragleave(a);this.dropzoneDragleave(a);this.files=a.originalEvent.dataTransfer.files;if(!(1>this.files.length)){a=b(a.target).parents(".wp-editor-wrap");0<a.length&&a[0].id&&(window.wpActiveEditor=a[0].id.slice(3,-5));if(this.workflow)this.workflow.state().reset(),this.addFiles.apply(this),this.workflow.open();
