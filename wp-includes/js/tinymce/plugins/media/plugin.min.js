...
m=f.height;var d;d=c.selection.getNode().getAttribute("data-mce-object")?c.selection.getContent():void 0;d={id:"mcemediasource",type:"textbox",flex:1,name:"embed",value:d,multiline:!0,label:"Source"};d[z]=function(){f=r(this.value());this.parent().parent().fromJSON(f)};b=c.windowManager.open({title:"Insert/edit video",data:f,bodyType:"tabpanel",body:[{title:"General",type:"form",onShowTab:function(){f=r(this.next().find("#embed").value());this.fromJSON(f)},items:h},{title:"Embed",type:"container",
...
allow_conditional_comments:!0,special:"script,noscript",start:function(a,c){b.source1||"param"!=a||(b.source1=c.map.movie);if("iframe"==a||"object"==a||"embed"==a||"video"==a||"audio"==a)b.type||(b.type=a),b=tinymce.extend(c.map,b);if("script"==a){var f=t(c.map.src);if(!f)return;b={type:"script",source1:c.map.src,width:f.width,height:f.height}}"source"==a&&(b.source1?b.source2||(b.source2=c.map.src):b.source1=c.map.src);"img"!=a||b.poster||(b.poster=c.map.src)}})).parse(a);b.source1=b.source1||b.src||
b.data;b.source2=b.source2||"";b.poster=b.poster||"";return b}function y(a){return a.getAttribute("data-mce-object")?r(c.serializer.serialize(a,{selection:!0})):{}}function B(a){if(!1===c.settings.media_filter_html)return a;var b=new tinymce.html.Writer,g;(new tinymce.html.SaxParser({validate:!1,allow_conditional_comments:!1,special:"script,noscript",comment:function(a){b.comment(a)},cdata:function(a){b.cdata(a)},text:function(a,c){b.text(a,c)},start:function(a,f,h){g=!0;if("script"!=a&&"noscript"!=
