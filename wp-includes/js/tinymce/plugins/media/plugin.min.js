tinymce.PluginManager.add("media",function(c,x){function u(a){a=a.toLowerCase();return-1!=a.indexOf(".mp3")?"audio/mpeg":-1!=a.indexOf(".wav")?"audio/wav":-1!=a.indexOf(".mp4")?"video/mp4":-1!=a.indexOf(".webm")?"video/webm":-1!=a.indexOf(".ogg")?"video/ogg":-1!=a.indexOf(".swf")?"application/x-shockwave-flash":""}function r(a){var b=c.settings.media_scripts;if(b)for(var g=0;g<b.length;g++)if(-1!==a.indexOf(b[g].filter))return b[g]}function t(){function a(a){var e,f,d,c;e=b.find("#width")[0];f=b.find("#height")[0];
...
a.type?b+('<script src="'+a.source1+'">\x3c/script>'):c.settings.video_template_callback?c.settings.video_template_callback(a):'<video width="'+a.width+'" height="'+a.height+'"'+(a.poster?' poster="'+a.poster+'"':"")+' controls="controls">\n<source src="'+a.source1+'"'+(a.source1mime?' type="'+a.source1mime+'"':"")+" />\n"+(a.source2?'<source src="'+a.source2+'"'+(a.source2mime?' type="'+a.source2mime+'"':"")+" />\n":"")+"</video>"}return b}function q(a){var b={};(new tinymce.html.SaxParser({validate:!1,
allow_conditional_comments:!0,special:"script,noscript",start:function(a,c){b.source1||"param"!=a||(b.source1=c.map.movie);if("iframe"==a||"object"==a||"embed"==a||"video"==a||"audio"==a)b.type||(b.type=a),b=tinymce.extend(c.map,b);if("script"==a){var f=r(c.map.src);if(!f)return;b={type:"script",source1:c.map.src,width:f.width,height:f.height}}"source"==a&&(b.source1?b.source2||(b.source2=c.map.src):b.source1=c.map.src);"img"!=a||b.poster||(b.poster=c.map.src)}})).parse(a);b.source1=b.source1||b.src||
b.data;b.source2=b.source2||"";b.poster=b.poster||"";return b}function y(a){return a.getAttribute("data-mce-object")?q(c.serializer.serialize(a,{selection:!0})):{}}function B(a){if(!1===c.settings.media_filter_html)return a;var b=new tinymce.html.Writer,g;(new tinymce.html.SaxParser({validate:!1,allow_conditional_comments:!1,special:"script,noscript",comment:function(a){b.comment(a)},cdata:function(a){b.cdata(a)},text:function(a,c){b.text(a,c)},start:function(a,f,h){g=!0;if("script"!=a&&"noscript"!=
a){for(var d=0;d<f.length;d++){if(0===f[d].name.indexOf("on"))return;"style"==f[d].name&&(f[d].value=c.dom.serializeStyle(c.dom.parseStyle(f[d].value),a))}b.start(a,f,h);g=!1}},end:function(a){g||b.end(a)}},new tinymce.html.Schema({}))).parse(a);return b.getContent()}function w(a,b,c){function m(a,b){var c,d,g,f;for(c in b)if(g=""+b[c],a.map[c])for(d=a.length;d--;)f=a[d],f.name==c&&(g?(a.map[c]=g,f.value=g):(delete a.map[c],a.splice(d,1)));else g&&(a.push({name:c,value:g}),a.map[c]=g)}var f=new tinymce.html.Writer,
...
type:"iframe",w:425,h:350,url:'//maps.google.com/maps/ms?msid=$2&output=embed"',allowFullscreen:!1}],z=tinymce.Env.ie&&8>=tinymce.Env.ie?"onChange":"onInput";c.on("ResolveName",function(a){var b;1==a.target.nodeType&&(b=a.target.getAttribute("data-mce-object"))&&(a.name=b)});c.on("preInit",function(){var a=c.schema.getSpecialElements();tinymce.each(["video","audio","iframe","object"],function(b){a[b]=new RegExp("</"+b+"[^>]*>","gi")});var b=c.schema.getBoolAttrs();tinymce.each(["webkitallowfullscreen",
"mozallowfullscreen","allowfullscreen"],function(a){b[a]={}});c.parser.addNodeFilter("iframe,video,audio,object,embed,script",function(a,b){for(var f=a.length,h,d,l,e,k,n,p;f--;)if(d=a[f],d.parent){if("script"==d.name&&(p=r(d.attr("src")),!p))continue;l=new tinymce.html.Node("img",1);l.shortEnded=!0;p&&(p.width&&d.attr("width",p.width.toString()),p.height&&d.attr("height",p.height.toString()));n=d.attributes;for(h=n.length;h--;)if(e=n[h].name,k=n[h].value,"width"!==e&&"height"!==e&&"style"!==e){if("data"==
...
1);"audio"!=k&&"script"!=k&&d.attr({width:h.attr("width"),height:h.attr("height")});d.attr({style:h.attr("style")});e=h.attributes;for(l=e.length;l--;){var n=e[l].name;0===n.indexOf("data-mce-p-")&&d.attr(n.substr(11),e[l].value)}"script"==k&&d.attr("type","text/javascript");if(l=h.attr("data-mce-html"))e=new tinymce.html.Node("#text",3),e.raw=!0,e.value=B(unescape(l)),d.append(e);h.replace(d)}})});c.on("ObjectSelected",function(a){var b=a.target.getAttribute("data-mce-object");"audio"!=b&&"script"!=
b||a.preventDefault()});c.on("objectResized",function(a){var b=a.target,c;b.getAttribute("data-mce-object")&&(c=b.getAttribute("data-mce-html"))&&(c=unescape(c),b.setAttribute("data-mce-html",escape(w(c,{width:a.width,height:a.height}))))});c.addButton("media",{tooltip:"Insert/edit video",onclick:t,stateSelector:["img[data-mce-object=video]","img[data-mce-object=iframe]"]});c.addMenuItem("media",{icon:"media",text:"Insert/edit video",onclick:t,context:"insert",prependToContext:!0});this.showDialog=
t});
