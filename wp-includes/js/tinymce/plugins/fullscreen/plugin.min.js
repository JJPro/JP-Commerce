tinymce.PluginManager.add("fullscreen",function(a){function t(){var a,b,e=window,c=document.body;c.offsetWidth&&(a=c.offsetWidth,b=c.offsetHeight);e.innerWidth&&e.innerHeight&&(a=e.innerWidth,b=e.innerHeight);return{w:a,h:b}}function d(){function l(){b.setStyle(d,"height",t().h-(g.clientHeight-d.clientHeight))}var p=document.body,e=document.documentElement,c,g,d,f;h=!h;g=a.getContainer();c=g.style;d=a.getContentAreaContainer().firstChild;f=d.style;h?(q=f.width,r=f.height,f.width=f.height="100%",m=
