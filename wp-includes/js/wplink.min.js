...
k.next()},prev:function(){h.prev();k.prev()},keydown:function(a){var c,d=e.ui.keyCode;d.ESCAPE===a.keyCode?(wpLink.close(),a.stopImmediatePropagation()):d.TAB===a.keyCode&&((c=a.target.id,"wp-link-submit"!==c||a.shiftKey)?"wp-link-close"===c&&a.shiftKey&&(b.submit.focus(),a.preventDefault()):(b.close.focus(),a.preventDefault()));if(a.keyCode===d.UP||a.keyCode===d.DOWN)if(!document.activeElement||"link-title-field"!==document.activeElement.id&&"url-field"!==document.activeElement.id)c=a.keyCode===
d.UP?"prev":"next",clearInterval(wpLink.keyInterval),wpLink[c](),wpLink.keyInterval=setInterval(wpLink[c],wpLink.keySensitivity),a.preventDefault()},keyup:function(a){var c=e.ui.keyCode;if(a.which===c.UP||a.which===c.DOWN)clearInterval(wpLink.keyInterval),a.preventDefault()},delayedCallback:function(a,c){var b,e,f,g;if(!c)return a;setTimeout(function(){if(e)return a.apply(g,f);b=!0},c);return function(){if(b)return a.apply(this,arguments);f=arguments;g=this;e=!0}},toggleInternalLinking:function(a){var c=
b.wrap.hasClass("search-panel-visible");b.wrap.toggleClass("search-panel-visible",!c);setUserSetting("wplink",c?"0":"1");b[c?"url":"search"].focus();a.preventDefault()}};l=function(a,c){var b=this;this.element=a;this.ul=a.children("ul");this.contentHeight=a.children("#link-selector-height");this.waiting=a.find(".river-waiting");this.change(c);this.refresh();e("#wp-link .query-results, #wp-link #link-selector").scroll(function(){b.maybeLoad()});a.on("click","li",function(a){b.select(e(this),a)})};
e.extend(l.prototype,{refresh:function(){this.deselect();this.visible=this.element.is(":visible")},show:function(){this.visible||(this.deselect(),this.element.show(),this.visible=!0)},hide:function(){this.element.hide();this.visible=!1},select:function(a,b){var d,e,f,g;a.hasClass("unselectable")||a==this.selected||(this.deselect(),this.selected=a.addClass("selected"),d=a.outerHeight(),e=this.element.height(),f=a.position().top,g=this.element.scrollTop(),0>f?this.element.scrollTop(g+f):f+d>e&&this.element.scrollTop(g+
f-e+d),this.element.trigger("river-select",[a,b,this]))},deselect:function(){this.selected&&this.selected.removeClass("selected");this.selected=!1},prev:function(){if(this.visible){var a;this.selected&&(a=this.selected.prev("li"),a.length&&this.select(a))}},next:function(){if(this.visible){var a=this.selected?this.selected.next("li"):e("li:not(.unselectable):first",this.element);a.length&&this.select(a)}},ajax:function(a){var b=this,d=wpLink.delayedCallback(function(d,e){b.process(d,e);a&&a(d,e)},
1==this.query.page?0:wpLink.minRiverAJAXDuration);this.query.ajax(d)},change:function(a){this.query&&this._search==a||(this._search=a,this.query=new n(a),this.element.scrollTop(0))},process:function(a,b){var d="",f=!0,h="",g=1==b.page;a?e.each(a,function(){h=f?"alternate":"";h+=this.title?"":" no-title";d+=h?'<li class="'+h+'">':"<li>";d+='<input type="hidden" class="item-permalink" value="'+this.permalink+'" />';d+='<span class="item-title">';d+=this.title?this.title:wpLinkL10n.noTitle;d+='</span><span class="item-info">'+
this.info+"</span></li>";f=!f}):g&&(d+='<li class="unselectable no-matches-found"><span class="item-title"><em>'+wpLinkL10n.noMatchesFound+"</em></span></li>");this.ul[g?"html":"append"](d)},maybeLoad:function(){var a=this,b=this.element,d=b.scrollTop()+b.height();!this.query.ready()||d<this.contentHeight.height()-wpLink.riverBottomThreshold||setTimeout(function(){var d=b.scrollTop(),e=d+b.height();!a.query.ready()||e<a.contentHeight.height()-wpLink.riverBottomThreshold||(a.waiting.addClass("is-active"),
b.scrollTop(d+a.waiting.outerHeight()),a.ajax(function(){a.waiting.removeClass("is-active")}))},wpLink.timeToTriggerRiver)}});n=function(a){this.page=1;this.querying=this.allLoaded=!1;this.search=a};e.extend(n.prototype,{ready:function(){return!(this.querying||this.allLoaded)},ajax:function(a){var c=this,d={action:"wp-link-ajax",page:this.page,_ajax_linking_nonce:b.nonce.val()};this.search&&(d.search=this.search);this.querying=!0;e.post(ajaxurl,d,function(b){c.page++;c.querying=!1;c.allLoaded=!b;
a(b,d)},"json")}});e(document).ready(wpLink.init)})(jQuery);
