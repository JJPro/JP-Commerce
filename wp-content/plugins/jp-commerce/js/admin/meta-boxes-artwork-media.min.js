...
method:"post",maxFiles:5,parallelUploads:6,acceptedFiles:"image/*",autoProcessQueue:!1,uploadMultiple:!1,previewTemplate:'<div class="dz-preview dz-file-preview">   <div class="dz-details">       <img data-dz-thumbnail />   </div>   <div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress></span></div>    <div class="controls">       <i class="dz-remove icon-x-circle" data-dz-remove title="Delete"></i>   </div></div> ',clickable:".dz-clickable",dictInvalidFileType:"Only images are allowed.",
dictResponseError:"Upload Failed. \nError Code: {{statusCode}}.",dictMaxFilesExceeded:"Exceeded number of files allowed.",init:function(){e=this;window.dropzone_api=this;F();I();var a,b;l.sortable({items:".dz-preview",containment:"parent",distance:20,tolerance:"pointer",start:function(b,d){a=d.item.index(".dz-preview")},update:function(c,d){b=d.item.index(".dz-preview");e.files.move(a,b)}});Array.prototype.move=function(a,b){this.splice(b,0,this.splice(a,1)[0])}}})})();(function(){d("form").on("submit",
function(a){a=e.files;for(var b,c=0,d=a.length;c<d;c++)(b=a[c],b.hasOwnProperty("order"))?b.hasOwnProperty("order")&&c!==b.order&&(b.order=c,h.updated_files.push({file_id:b.file_id,order:c})):(b.order=c,h.added_files.push(c));if(f||t())return!0;t()||(r.dialog({modal:!0,dialogClass:"noTitleStuff fixed-dialog"}),L(),M(),e.processQueue());return!1})})()});
